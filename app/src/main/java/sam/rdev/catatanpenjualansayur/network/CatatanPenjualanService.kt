package sam.rdev.catatanpenjualansayur.network

import sam.rdev.catatanpenjualansayur.activity.data_barang.data.ResultDataBarang
import sam.rdev.catatanpenjualansayur.activity.login.data.ResultLogin
import sam.rdev.catatanpenjualansayur.activity.penjualan.data.ResultKeranjang
import sam.rdev.catatanpenjualansayur.activity.penjualan.data.ResultSearchBarang
import sam.rdev.catatanpenjualansayur.activity.report.detail.data.ResultItemKeranjang
